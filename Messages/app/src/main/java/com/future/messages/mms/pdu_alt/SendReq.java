...
package com.future.messages.mms.pdu_alt;
...
import com.future.messages.mms.InvalidHeaderValueException;
...
public class SendReq extends MultimediaMessagePdu {
    ...
    // prepareFromAddress() removed from the upstream source: it looked up the device's own
    // phone number to set as From, but SendReq's default constructor already sets From to
    // "insert-address-token" (PduHeaders.FROM_INSERT_ADDRESS_TOKEN_STR), which tells the MMSC
    // to fill in the subscriber's address itself - the standard, simpler approach.
