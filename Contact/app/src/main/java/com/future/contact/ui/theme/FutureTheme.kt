package com.future.contact.ui.theme

import androidx.compose.ui.graphics.Color

/**
 * עיצוב משותף בין כל אפליקציות FutureOS (כהה/בהיר, צבע הדגשה), נטען דרך
 * ThemeClient מה-ContentProvider של FutureUI. מקביל ל-ThemeConfig באפליקציית
 * ההגדרות, מצומצם למה שאפליקציית אנשי הקשר צריכה בפועל.
 */
