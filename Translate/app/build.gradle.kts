...
android {
    namespace = "com.future.translate"
    compileSdk = 37

    defaultConfig {
        applicationId = "com.future.translate"
        minSdk = 31
        targetSdk = 31
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // תרגום וזיהוי שפה על המכשיר (ML Kit) - מודל לכל שפה יורד פעם אחת
    // ומשם התרגום עובד בלי רשת. זה מה ש"הורדת שפה" בתפריט מנהל.
